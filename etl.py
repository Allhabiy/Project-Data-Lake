...
def process_log_data(spark, input_data, output_data):
    ...
    song_df = spark.read.parquet("s3a://gfkw-dend-udacity/project4/songs_table")
    song_df.createOrReplaceTempView("songs_table")

    print("Reading artist parquet file..")
    artist_df = spark.read.parquet("s3a://gfkw-dend-udacity/project4/artists_table")
...
def main():
    ...
    output_data = "s3a://gfkw-dend-udacity/project4/"
